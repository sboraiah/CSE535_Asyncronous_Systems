...
(* Credits: CACM 21(7):558-565, 1978.                                      *)
...
\**************** MaxClock acts as a termination condition *****************)
CONSTANT N, maxClock

ASSUME NType == N \in Nat
ASSUME maxClockType == maxClock \in Nat

\************** Limit the Proc to work for NaturalNumber N ****************)
Proc == 1 .. N

\****** Defining Clock to work for NaturalNumbers starting from 1 *********)
Clock == Nat \ {0}
...
\**** Mapping the messages to type of the mesages used in the algorithm ****)
...
(* WF is not able to check Liveness property*)
-----------------------------------------------------------------------------
(***************************************************************************)
...
\***************************************************************************)
EnsureSafety == \A p,q \in crit : p = q

\***************************************************************************)
\* The main Liveness property of mutual exclusion.                         *)
\***************************************************************************)
EventuallyLive == \A p \in Proc : <>(p \in crit)
